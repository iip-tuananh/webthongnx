...
class FrontController extends Controller
{
    ...
    public function getPostByCate(Request $request) {
        ...
        if(! $category->parent_id) {
            $cateIds = PostCategory::query()->where('parent_id', $category->id)->pluck('id')->toArray();
    ...
    public function blogs(Request $request, $slug = null) {
        ...
        if($slug) {
            ...
            if(! $category->parent_id) {
                ...
                $parentCate = PostCategory::query()->where('id', $category->parent_id)->first();
            }
        ...
        return view('site.blog', compact('posts', 'category', 'categories', 'tags', 'popularPosts', 'postsRecent', 'parentCate'));
    }
